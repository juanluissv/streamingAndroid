...
$( "#myElement654" ).remove();
$(".Element99").append('<div id="myElement654"></div>');
...
playerInstance.on('adComplete', function() {
   ...
   if (( adnumber > 12) && (( adnumber < 17))) {
        console.log('playad3')
        console.log(adnumber);        
        playerInstance.playAd("https://servedbyadbutler.com/vast.spark?setID=7656&ID=172550&pid=72411");
    }

   if (( adnumber > 19) && (( adnumber < 24))) {
        console.log('playad4')
        console.log(adnumber);        
        playerInstance.playAd("https://servedbyadbutler.com/vast.spark?setID=7656&ID=172550&pid=72411");
    }

   if (( adnumber > 26) && (( adnumber < 31))) {
        console.log('playad5')
        console.log(adnumber);        
        playerInstance.playAd("https://servedbyadbutler.com/vast.spark?setID=7656&ID=172550&pid=72411");
    }

   if (( adnumber > 33) && (( adnumber < 38))) {
        console.log('playad6')
        console.log(adnumber);        
        playerInstance.playAd("https://servedbyadbutler.com/vast.spark?setID=7656&ID=172550&pid=72411");
    }
   if (( adnumber > 40) && (( adnumber < 45))) {
        console.log('playad7')
        console.log(adnumber);        
        playerInstance.playAd("https://servedbyadbutler.com/vast.spark?setID=7656&ID=172550&pid=72411");
    }

   if (( adnumber > 47) && (( adnumber < 52))) {
        console.log('playad8')
        console.log(adnumber);        
        playerInstance.playAd("https://servedbyadbutler.com/vast.spark?setID=7656&ID=172550&pid=72411");
    }
   if (( adnumber > 54) && (( adnumber < 59))) {
        console.log('playad9')
        console.log(adnumber);        
        playerInstance.playAd("https://servedbyadbutler.com/vast.spark?setID=7656&ID=172550&pid=72411");
    }
   if (( adnumber > 61) && (( adnumber < 66))) {
        console.log('playad10')
        console.log(adnumber);        
        playerInstance.playAd("https://servedbyadbutler.com/vast.spark?setID=7656&ID=172550&pid=72411");
    }
   if (( adnumber > 68) && (( adnumber < 73))) {
        console.log('playad11')
        console.log(adnumber);        
        playerInstance.playAd("https://servedbyadbutler.com/vast.spark?setID=7656&ID=172550&pid=72411");
    }
   if (( adnumber > 75) && (( adnumber < 80))) {
        console.log('playad12')
        console.log(adnumber);        
        playerInstance.playAd("https://servedbyadbutler.com/vast.spark?setID=7656&ID=172550&pid=72411");
    }
   if (( adnumber > 82) && (( adnumber < 87))) {
        console.log('playad13')
        console.log(adnumber);        
        playerInstance.playAd("https://servedbyadbutler.com/vast.spark?setID=7656&ID=172550&pid=72411");
    }
   if (( adnumber > 89) && (( adnumber < 94))) {
