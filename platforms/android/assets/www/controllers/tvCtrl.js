...
theApp2.controller('tvCtrl', ['$scope', 'Account', '$stateParams', '$ionicScrollDelegate',  '$http', 
 function($scope, Account, $stateParams, $ionicScrollDelegate,  $http) {
...
$(".panib").append( "<div id='myElement6541'></div> " );
...
$(".panib").append( "<div id='myElement654'></div> " );
...
var theplaylist2 = []
 ...
 playerInstance = jwplayer("myElement523")
...
thefile = theplaylist2[0].sources[0].file

console.log(thefile)
console.log(thesec)

thesec = Number(thesec)
...
playerInstance.on('pause', function(oldstate) {
    playerInstance.play();    
...
// playerInstance.on('error', function(oldstate) {
...
// playerInstance.on('buffer', function(oldstate) {
//   if (oldstate.reason == "stalled") {
...
// var runcontroll1 = function() {
// var start;

// var p = 0; //buttonpress2
// var t = 10;
...
// var butonpresion2 = function(){

//   if( window.localStorage )
//   {
//     if( !localStorage.getItem('ochoLoad') )
//     {
//       localStorage['ochoLoad'] = true;
//       window.location.reload();
//     }  
//     else
//       localStorage.removeItem('ochoLoad');
//   }

//   if( window.localStorage )
//   {
//     if( !localStorage.getItem('ochoLoad2') )
//     {
//       localStorage['ochoLoad2'] = true;
//       window.location.reload();
//     }  
//     else
//       localStorage.removeItem('ochoLoad2');
//   }
...
//   if( window.localStorage )
//   {
//     if( !localStorage.getItem('dosLoad') )
//     {
//       localStorage['dosLoad'] = true;
//       window.location.reload();
//     }  
//     else
//       localStorage.removeItem('dosLoad');
//   }
// })();
...
// var timer22 = moment.duration(15, "seconds").timer({  
//     }, function() { 
//         countt = countt + 1;
// });
